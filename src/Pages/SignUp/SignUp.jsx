    ...
    <div className="hero bg-base-200 min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="card-body">
            ...
            <div className="form-control">
              ...
              {errors.password?.type === "pattern" && (
                <p className="text-red-500">Password must have 1 uppercase, one lowercase, one number and one special character </p>
              )}
              <label className="label">
          ...
          <p><small className="p-5">Already Have An Account? <Link className="text-yellow-500" to='/login'>Login</Link></small></p>
        </div>
      </div>
    </div>
    </>
